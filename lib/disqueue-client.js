...
function DisqueClient ( redisClient, options ) {

	debug( 'Construct disqueClient' );

	this.redisClient = redisClient;
	this.netStream = redisClient.stream;
...
function createConnection ( options ) {
	...
	var redisClient = redis.createClient( netOptions );
	var disqueClient = new DisqueClient( redisClient, options );
