...
DisqueClient.prototype.initParser = function () {
	...
	self.parser = new Parser( {
		'returnBuffers' : self.options.returnBuffers || false,
...
function createConnection ( options ) {
	...
	if (options.returnBuffers) {
		// redis requires buffers as `return_buffers`
		// https://github.com/NodeRedis/node-redis/blob/0041e3e53d5292b13d96ce076653c5b91b314fda/index.js#L85
        	netOptions.return_buffers = true;
	}
